...
function page() {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Mika Geshan.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Mika Geshan, accessible from{" "}
            <a
              href="http://mikageshan.com"
      ...
      <ul>
        <li>By email: mikageshan@gmail.com</li>
      </ul>
    </div>
  );
}
